...
class CRM_Contact_Form_Task_PDFLetterCommon extends CRM_Core_Form_Task_PDFLetterCommon {
  ...
  public static function postProcess(&$form) {
    ...
    // To get the pages sorted according to sorted name
    // 
    // unsorted version from CiviCRM 5.41.0
    // foreach ($form->_contactIds as $item => $contactId) {
    //
    // Version from 20210914
    $_sortedContacts = civicrm_api4('Contact', 'get', [
        'select' => [
            'id', 
            'sort_name',
        ],
    ...
    foreach ($_sortedContacts as $item => $currentContact) {
